...
**/
class Medma_MarketPlace_Block_Adminhtml_Catalog_Product_Edit_Tabs extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tabs
{
	protected function _prepareLayout()
    {
        ...
        {
			$this->addTab('vendor_duplicate_product', array(
                'label'     => Mage::helper('marketplace')->__('Vendor Refernce Product'),
                'content'   => $this->_translateHtml($this->getLayout()
                  ->createBlock('marketplace/adminhtml_catalog_product_edit_tab_vendor_duplicate_product')->toHtml()),
                'active'    => true
            ));
