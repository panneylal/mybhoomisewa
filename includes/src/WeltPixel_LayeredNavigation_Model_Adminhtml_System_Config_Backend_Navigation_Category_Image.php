...
class WeltPixel_LayeredNavigation_Model_Adminhtml_System_Config_Backend_Navigation_Category_Image extends Mage_Adminhtml_Model_System_Config_Backend_Image
{
    /**
     * The tail part of directory path for uploading
     */
    const UPLOAD_DIR                = 'layerednavigation/categoryimage';
